...
function SendSaveAsFileHeaderIfNeeded() {
	...
	global $phpThumb;
	$downloadfilename = phpthumb_functions::SanitizeFilename(@$_GET['sia'] ? $_GET['sia'] : (@$_GET['down'] ? $_GET['down'] : 'jumultithumb_joomla-ua.org'));
	if (@$downloadfilename) {
