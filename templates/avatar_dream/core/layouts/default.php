		...
		<div class="avatar-wrapper">
			<?php if ($template->params->get('go_to_top')): ?>
				<a id="avatar-go-to-top" href="#top">
					<span><?php echo JText::_('AVATAR_TEMPLATE_CORE_GO_TO_TOP'); ?></span>
				</a>
			<?php endif; ?>
			...
			<div id="avatar-body-middle">
				<?php if ($posLeftTop || $posLeftMiddle1 || $posLeftMiddle2 || $posLeftBottom): ?>
					<div id="avatar-left">
						<?php if ($posLeftTop): ?>
				...
				<?php if ($posRightTop || $posRightMiddle1 || $posRightMiddle2 || $posRightBottom): ?>
					<div id="avatar-right">
						<?php if ($posRightTop): ?>
