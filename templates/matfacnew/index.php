...
<div class="art-logo">
 <h1 class="art-logo-name"><a href="<?php echo $document->baseurl; ?>/">Математичний факультет<?php echo $this->params->get('siteTitle'); ?></a></h1>
    ...
    <div class="art-footer-body">
        <?php echo $view->position('position-14'); ?>
                <div class="art-footer-text">
                    ...
                    <?php else: ?>
                    <?php ob_start(); ?>
<!--<p><a href="#">Link1</a> | <a href="#">Link2</a> | <a href="#">Link3</a></p>--><p>Copyright © 2012. Математичний факультет ЗНУ.</p>
