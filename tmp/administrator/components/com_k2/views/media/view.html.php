<?php
/**
 * @version		$Id: view.html.php 1711 2012-10-06 02:43:36Z joomlaworks $
 * @package		K2
...
class K2ViewMedia extends K2View
{
    ...
    function display($tpl = null)
    {
        ...
        $document->addStyleSheet(JURI::root(true).'/media/k2/assets/css/theme.css?v=2.6.0');
        $document->addStyleSheet(JURI::root(true).'/media/k2/assets/css/elfinder.min.css?v=2.6.0');
