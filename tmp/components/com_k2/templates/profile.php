<?php
/**
 * @version		$Id: profile.php 1618 2012-09-21 11:23:08Z lefteris.kavadas $
 * @package		K2
...
<form action="<?php echo JURI::root(true); ?>/index.php" enctype="multipart/form-data" method="post" name="userform" autocomplete="off" class="form-validate">
	...
	<div id="k2Container" class="k2AccountPage">
		<table class="admintable" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td>
					<input class="inputbox validate-password" type="password" id="password" name="<?php echo (K2_JVERSION != '15')?'jform[password1]':'password'?>" size="40" value="" />
				</td>
			</tr>
			<tr>
				<td class="key">
				...
				<td>
					<input class="inputbox validate-passverify" type="password" id="password2" name="<?php echo (K2_JVERSION != '15')?'jform[password2]':'password2'?>" size="40" value="" />
				</td>
			</tr>
			<tr>
				<th colspan="2" class="k2ProfileHeading">
	...
	<input type="hidden" name="<?php echo (K2_JVERSION != '15')?'jform[username]':'username'?>" value="<?php echo $this->user->get('username'); ?>" />
	<input type="hidden" name="<?php echo (K2_JVERSION != '15')?'jform[id]':'id'?>" value="<?php echo $this->user->get('id'); ?>" />
	<input type="hidden" name="gid" value="<?php echo $this->user->get('gid'); ?>" />
	<input type="hidden" name="option" value="<?php echo (K2_JVERSION != '15')?'com_users':'com_user'?>" />
	<input type="hidden" name="task" value="<?php echo (K2_JVERSION != '15')?'profile.save':'save'?>" />
