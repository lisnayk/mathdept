<?php
/**
 * @version		$Id: register.php 1618 2012-09-21 11:23:08Z lefteris.kavadas $
 * @package		K2
...
<form action="<?php echo JURI::root(true); ?>/index.php" enctype="multipart/form-data" method="post" id="josForm" name="josForm" class="form-validate">
	...
	<div id="k2Container" class="k2AccountPage">
		<table class="admintable" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td>
					<input type="text" name="<?php echo (K2_JVERSION != '15')?'jform[name]':'name'?>" id="name" size="40" value="<?php echo $this->escape($this->user->get( 'name' )); ?>" class="inputbox required" maxlength="50" />
					*
				</td>
			</tr>
			<tr>
				...
				<td>
					<input type="text" id="username" name="<?php echo (K2_JVERSION != '15')?'jform[username]':'username'?>" size="40" value="<?php echo $this->escape($this->user->get( 'username' )); ?>" class="inputbox required validate-username" maxlength="25" />
					*
				</td>
			</tr>
			<tr>
				...
				<td>
					<input type="text" id="email" name="<?php echo (K2_JVERSION != '15')?'jform[email1]':'email'?>" size="40" value="<?php echo $this->escape($this->user->get( 'email' )); ?>" class="inputbox required validate-email" maxlength="100" />
					*
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input class="inputbox required validate-password" type="password" id="password" name="<?php echo (K2_JVERSION != '15')?'jform[password1]':'password'?>" size="40" value="" />
					*
				</td>
			</tr>
			<tr>
				...
				<td>
					<input class="inputbox required validate-passverify" type="password" id="password2" name="<?php echo (K2_JVERSION != '15')?'jform[password2]':'password2'?>" size="40" value="" />
					*
				</td>
			</tr>
			<tr>
	...
	<input type="hidden" name="task" value="<?php echo (K2_JVERSION != '15')?'registration.register':'register_save'?>" />
