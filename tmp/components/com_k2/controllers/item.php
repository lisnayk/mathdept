<?php
/**
 * @version		$Id: item.php 1682 2012-10-05 10:47:28Z lefteris.kavadas $
 * @package		K2
...
\$K2('#commentEmail').val('".$user->email."').attr('disabled', 'disabled');";
    ...
    function edit()
    {
        ...
        // CSS
        $document->addStyleSheet(JURI::root(true).'/media/k2/assets/css/k2.css?v=2.6.0');
        $document->addStyleSheet(JURI::root(true).'/media/k2/assets/css/k2.frontend.css?v=2.6.0');
        $document->addStyleSheet(JURI::root(true).'/templates/system/css/general.css');
        $document->addStyleSheet(JURI::root(true).'/templates/system/css/system.css');

        // JS
        K2HelperHTML::loadjQuery(true);
        $document->addScript(JURI::root(true).'/media/k2/assets/js/k2.js?v=2.6.0');
