...
?>";
    ...
    <dl id="system-message">
        ...
        <dd class="message notice fade">
           	<ul>
           		<li>'. JText::_('PLG_JUMULTITHUMB_NOTICE17') .'</li>
           		<li>'. JText::_('PLG_JUMULTITHUMB_NOTICE18') .'</li>
        	</ul>
        </dd>
    </dl>
            ';
...
?>";
    ...
    <dl id="system-message">
        ...
        <dd class="message notice fade">
         	<ul>
           		<li>'. JText::_('PLG_JUMULTITHUMB_NOTICE20') .'</li>
           		<li>'. JText::_('PLG_JUMULTITHUMB_NOTICE18') .'</li>
           	</ul>
        </dd>
    </dl>
...
?>";
    ...
    <dl id="system-message">
        ...
        <dd class="message message fade">
           	<ul>
           		<li>'. JText::_('PLG_JUMULTITHUMB_NOTICE19') .'</li>
        	</ul>
        </dd>
    </dl>
            ';
...
<title><?php echo JText::_('PLG_JUMULTITHUMB_IMAGE_CONF'); ?></title>
...
<?php else: ?>
<fieldset class="adminform">
    <legend><?php echo JText::_('PLG_JUMULTITHUMB_IMAGE_CONF'); ?></legend>
    <?php
    if(isset($notice)){
      echo $notice;
    }
    ...
    <form name="imgsetting" id="imgsetting" action="imgsetting.php" method="post">
        <p>
            <label><?php echo JText::_('PLG_JUMULTITHUMB_IMAGE_CONF01'); ?></label>
            <span class="input">
            ...
            <span class="clear jutips"><?php echo JText::_('PLG_JUMULTITHUMB_IMAGE_CONF01_TIPS'); ?></span>
        </p>

        <p>
            <label><?php echo JText::_('PLG_JUMULTITHUMB_IMAGE_CONF02'); ?></label>
            <span class="input">
            ...
            <span class="clear jutips"><?php echo JText::_('PLG_JUMULTITHUMB_IMAGE_CONF02_TIPS'); ?></span>
        </p>

        <p>
            <label><?php echo JText::_('PLG_JUMULTITHUMB_IMAGE_CONF03'); ?></label>
            <span class="input">
            <input type="text" name="juimagemagickpath" id="juimagemagickpath" value="<?php echo $juimagemagickpath; ?>" size="50" />
            </span>
            <span class="clear jutips"><?php echo JText::_('PLG_JUMULTITHUMB_IMAGE_CONF03_TIPS'); ?></span>
        </p>

        <p>
            <label><?php echo JText::_('PLG_JUMULTITHUMB_IMAGE_CONF04'); ?></label>
            <span class="input">
            ...
            <span class="clear jutips"><?php echo JText::_('PLG_JUMULTITHUMB_IMAGE_CONF04_TIPS'); ?></span>
        </p>

        <p>
            <label><?php echo JText::_('PLG_JUMULTITHUMB_IMAGE_CONF05'); ?></label>
            <span class="input">
            <input type="text" name="jumaxage" id="jumaxage" value="<?php echo $jumaxage; ?>" size="6" />
            </span>
            <span class="clear jutips"><?php echo JText::_('PLG_JUMULTITHUMB_IMAGE_CONF05_TIPS'); ?></span>
        </p>

        <p>
            <label><?php echo JText::_('PLG_JUMULTITHUMB_IMAGE_CONF06'); ?></label>
            <span class="input">
            <input type="text" name="jumaxsize" id="jumaxsize" value="<?php echo $jumaxsize; ?>" size="6" />
            </span>
            <span class="clear jutips"><?php echo JText::_('PLG_JUMULTITHUMB_IMAGE_CONF06_TIPS'); ?></span>
        </p>

        <p>
            <label><?php echo JText::_('PLG_JUMULTITHUMB_IMAGE_CONF07'); ?></label>
            <span class="input">
            <input type="text" name="jumaxfiles" id="jumaxfiles" value="<?php echo $jumaxfiles; ?>" size="6" />
            </span>
            <span class="clear jutips"><?php echo JText::_('PLG_JUMULTITHUMB_IMAGE_CONF07_TIPS'); ?></span>
        </p>

        <p><input type="submit" name="save" id="save" value="<?php echo JText::_('PLG_JUMULTITHUMB_IMAGE_CONF_SAVE'); ?>" /></p>
    </form>
</fieldset>
<?php endif; ?>
</body>
