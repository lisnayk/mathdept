...
class nnFieldToggler
{
	...
	function getInput( $name, $id, $value, $params, $children, $j15 = 0 )
	{
		...
		$document->addScript( JURI::root( true ).'/plugins/content/jumultithumb/assets/script.js?v='.$this->_version );
		$document->addScript( JURI::root( true ).'/plugins/content/jumultithumb/assets/toggler.js?v='.$this->_version );
